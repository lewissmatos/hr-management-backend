...
export class CandidateController {
	static async getAll(req: Request, res: Response) {
		try {
			...
			res.json(
				createResponse("Training found", 200, paginatedRes.data, {
	...
	static async getOne(req: Request, res: Response) {
		try {
			...
			res.json(createResponse("Candidate found", 200, data));
		} catch (error: any) {
	...
	static async update(req: Request, res: Response) {
		try {
			...
			res.json(createResponse("Candidate updated", 200, data));
		} catch (error: any) {
	...
	static async makeEmployee(req: Request, res: Response) {
		try {
			...
			res.json(createResponse("Candidate made employee", 200, data));
		} catch (error: any) {
			res.status(400).json({ message: error.message });
		}
	}
