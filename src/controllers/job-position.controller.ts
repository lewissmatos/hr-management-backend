...
export class JobPositionController {
    ...
    static async getOne(req: Request, res: Response) {
        ...
        try {
            ...
            res
                .status(404)
                .json(createResponse(e.message || "Puesto de trabajo no encontrado", 404));
        }
    }
    static async create(req: Request, res: Response) {
        try {
            ...
            res
                .status(201)
                .json(createResponse("Puesto de trabajo creado exitosamente", 201, data));
        } catch (e: any) {
    ...
    static async update(req: Request, res: Response) {
        ...
        try {
            ...
            res.json(createResponse("Puesto de trabajo actualizado exitosamente", 200, data));
        } catch (e: any) {
            res
                .status(404)
                .json(createResponse(e.message || "Puesto de trabajo no encontrado", 404));
